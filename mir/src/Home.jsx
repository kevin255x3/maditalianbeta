...
function Home() {
    ...
    return (
        <div className="w-full pt-16 bg-[#FDF8ED]"> {/* Main container with brand background */}
            {/* Title section */}
            <h1 className="text-4xl sm:text-5xl tablet:text-6xl md:text-7xl font-bold text-[#33312B] pt-4 pb-6 px-4">
                THE MAD ITALIAN, HOME OF THE BEST PIZZA AND PINTS IN LANGLEY
            </h1>

            {/* Pizza and Beer Image Section - PARALLAX REMAINS */}
            <div className="w-full flex flex-col tablet:flex-row">
                <div className="w-full tablet:w-1/2 h-[50vh] tablet:h-[70vh] md:h-[80vh] relative overflow-hidden">
                    <div
            ...
            <div>
                ...
                <div className="w-full bg-[#333133] py-6">
                    <h2 className="text-4xl tablet:text-5xl md:text-6xl font-black text-[#FDF8ED] px-4 leading-tight">
            ...
            <div className="w-full flex flex-col tablet:flex-row">
                <div className="w-full tablet:w-1/2 h-[40vh] tablet:h-[60vh] md:h-[70vh] relative overflow-hidden">
                    <div
            ...
            <div>
                {/* Cocktail Titles */}
                <div>
                    <h2 className="text-4xl sm:text-5xl tablet:text-5xl md:text-6xl font-black text-[#33312B] bg-[#FDF8ED] py-4 px-4">
                        SOMETIMES, ALWAYS, WHENEVER
                    </h2>
                    {/* Changed background from red to warm black */}
                    <div className="bg-[#333133] py-4 px-4">
                        <h3 className="text-4xl sm:text-5xl tablet:text-5xl md:text-6xl font-black text-[#FDF8ED]">
                ...
                <div className="w-full bg-[#FDF8ED] flex flex-col tablet:flex-row">
                ...
                <div className="w-screen h-[40vh] tablet:h-[45vh] md:h-[50vh] relative overflow-hidden"> {/* Removed mb-16 */}
                    <div
                ...
                <div className="bg-[#333133] py-4 sm:py-6 px-4">
                    <Link to="/menu" className="block">
                        <h3 className="text-5xl sm:text-6xl tablet:text-7xl md:text-7xl lg:text-8xl font-black text-[#FDF8ED] hover:underline cursor-pointer"> {/* Adjusted font sizes */}
                            MENU
                        </h3>
                    </Link>
                </div>
